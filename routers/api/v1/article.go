...
func AddArticle(c *gin.Context) {
	...
	valid.Required(coverImageUrl, "cover_image_url").Message("路径不能为空")
...
func EditArticle(c *gin.Context) {
	...
	valid.MaxSize(coverImageUrl, 65535, "cover_image_url").Message("路径最长为65535字符")
